export const translations = {
    pt: {
        ...
        "faq-a5": "<p>O Treinamento Async foca na eficiência e autonomia com suporte contínuo.</p><p><strong>O que inclui:</strong> Suporte e direcionamento direto pelo WhatsApp pessoal do mentor, acesso ao grupo de vagas e descontos exclusivos con professor nativo (EUA).</p><p><strong>O que não inclui:</strong> Agenda síncrona/reuniões agendadas 'one-on-one' (ex: chamadas de 1h).</p>",
